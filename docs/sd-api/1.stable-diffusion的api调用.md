...
关于 controlnet 的调用参考: https://github.com/AUTOMATIC1111/stable-diffusion-webui/discussions/10468  
sd webui api 调用参考: https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/API  
